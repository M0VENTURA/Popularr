...
(function (global) {
  ...
  */
  ...
  /*
    Reported as "I can't hide the missing releases that are populated" — the
    inverse case is an OWNED album with gaps, which should advertise them.
    Only rows that have a MusicBrainz id are probed, because the endpoint keys
    on the MBID.
  */
