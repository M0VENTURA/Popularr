 ...
 *   foreign equivalents (Les/Los/Die). Keep ARTICLES in step with
 *   ARTICLES in helpers/artist_sort.py.
 ...
 *
 * Loaded by base.html (after utils/dom.js) so search-flyout.js and page modules
 * can use it. See also: helpers/artist_sort.py, templates/components/… .
 */
(function (global) {
  'use strict';
